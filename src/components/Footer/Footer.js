...
const Footer = () => {
  return (
    <FooterWrapper>
      ...
      <LinkItem href="mailto:michealduruaku88@gmail.com">michealduruaku88@gmail.com</LinkItem>
      </LinkColumn>
      </LinkList>
      <SocialIconsContainer>
        <CompanyContainer>
          <Slogan>Life before death. Strength before weakness. Journey before destination.</Slogan>
        </CompanyContainer>
        <SocialContainer>
